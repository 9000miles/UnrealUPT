	...
	[
		...
		[
			...
			[
				...
				[
					SNew( SBorder )
#pragma region // ContentBrowser左上角 AddNew，Import，SaveAll - 
...
#pragma endregion
	...
	PathViewPtr->OnFolderPathChanged.BindLambda([this](const TArray<struct FMovedContentFolder>& MovedFolders)
	{
		...
		FContentBrowserModule::FOnRenameFolder& RenameFolderDelegate = ContentBrowserModule.GetOnRenameFolder();
	...
	ContentBrowserModule.GetOnRequestNewFolder().AddLambda([&]() 
	{ 
...
void SContentBrowser::OpenSourcesViewExpanded()
{
...
TSharedPtr<SWidget> SContentBrowser::OnGetAssetContextMenu(const TArray<FAssetData>& SelectedAssets)
{
	...
	{
#pragma region // ContentBrowser右键菜单
...
void SContentBrowser::OnOpenedFolderDeleted(TArray<FString>& SelectedPaths)
{
	...
	FContentBrowserModule& ContentBrowserModule = FModuleManager::GetModuleChecked<FContentBrowserModule>(TEXT("ContentBrowser"));
	FContentBrowserModule::FOnDeletedFolder& DeletedFolderDelegate = ContentBrowserModule.GetOnDeletedFolder();
